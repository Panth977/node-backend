...
export type AsyncGeneratorWrapperBuild<
    ...
    C extends Context,
> = WFn<C & AsyncGeneratorParam<N, I, Y, TN, O, S, C>, I['_output'], Y['_input'], TN['_output'], O['_input']>;
...
> = {
    ...
    func: Fn<C & AsyncGeneratorParam<N, I, Y, TN, O, S, C>, I['_output'], Y['_input'], TN['_output'], O['_input']>;
};
